...
// app/tailwind.css
var tailwind_default = "/build/_assets/tailwind-NUOWUYNL.css";
...
function Index() {
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { children: [
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("nav", { className: "nav py-4", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "flex justify-between items-center", children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("h1", { className: "text-xl font-bold text-neighborhood-spruce", children: "Toolshed" }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "flex gap-4 items-center", children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_react13.Link, { to: "/login", className: "text-neighborhood-slate hover:text-neighborhood-spruce", children: "Sign In" }),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_react13.Link, { to: "/register", className: "btn btn-primary", children: "Join" })
      ] })
    ] }) }) }),
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("main", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12", children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("header", { className: "text-center mb-12", children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("h2", { className: "text-4xl font-bold text-neighborhood-spruce mb-4", children: "Welcome to Toolshed" }),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("p", { className: "text-xl text-neighborhood-slate max-w-2xl mx-auto", children: "Share tools, borrow equipment, and build stronger communities. Connect with neighbors to share resources and reduce waste." })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8 mb-12", children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "card p-8", children: [
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("h3", { className: "text-lg font-semibold text-neighborhood-spruce mb-4", children: "Share Your Tools" }),
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("p", { className: "text-neighborhood-slate mb-4", children: "List tools you're willing to lend to neighbors. From power drills to garden equipment, help your community access what they need." }),
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_react13.Link, { to: "/share", className: "text-neighborhood-goldenrod hover:text-neighborhood-hover font-medium", children: "Start Sharing \u2192" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "card p-8", children: [
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("h3", { className: "text-lg font-semibold text-neighborhood-spruce mb-4", children: "Find What You Need" }),
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("p", { className: "text-neighborhood-slate mb-4", children: "Browse available tools in your neighborhood. Save money and reduce waste by borrowing instead of buying." }),
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_react13.Link, { to: "/browse", className: "text-neighborhood-goldenrod hover:text-neighborhood-hover font-medium", children: "Browse Tools \u2192" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "card p-8", children: [
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("h3", { className: "text-lg font-semibold text-neighborhood-spruce mb-4", children: "Build Community" }),
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("p", { className: "text-neighborhood-slate mb-4", children: "Connect with neighbors, build trust, and create a stronger, more sustainable community together." }),
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_react13.Link, { to: "/login", className: "text-neighborhood-goldenrod hover:text-neighborhood-hover font-medium", children: "Get Started \u2192" })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "text-center bg-gradient-to-r from-neighborhood-mint/20 to-neighborhood-cloud border border-neighborhood-mint/20 rounded-xl p-8", children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("h3", { className: "text-2xl font-semibold text-neighborhood-spruce mb-4", children: "Ready to get started?" }),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("p", { className: "text-neighborhood-slate mb-6 max-w-md mx-auto", children: "Join our community and start sharing resources with your neighbors today." }),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "flex gap-4 justify-center flex-wrap", children: [
...
var import_jsx_runtime14 = require("react/jsx-runtime"), meta11 = () => [{ title: "Sign In - Toolshed" }];
async function action11({ request }) {
  ...
  try {
    ...
    return user ? (0, import_node21.redirect)("/profile", {
      headers: {
        "Set-Cookie": `user_session=${user.id}; HttpOnly; Path=/; Max-Age=${7 * 24 * 60 * 60}; SameSite=Strict`
      }
    }) : (0, import_node21.json)({ error: "Invalid email or password" }, { status: 401 });
  } catch (error) {
...
function Login2() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "card w-full max-w-md p-8", children: [
    /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "text-center mb-8", children: [
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("h1", { className: "text-3xl font-bold text-neighborhood-spruce mb-2", children: "Sign in to Toolshed" }),
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("p", { className: "text-neighborhood-slate", children: "Welcome back to your community" })
    ] }),
